...
import { useNavigate } from "react-router-dom"; // Redirect mate
...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Agar product successfully add thai jay
   if (response.status === 200 || response.status === 201) {
    alert("Masterpiece added to collection.");
        ...
        <main className="p-8 lg:p-12 max-w-5xl mx-auto w-full">
          <div className="mb-10 text-center md:text-left">
            ...
            <h1 className="text-4xl font-serif font-bold text-slate-900 tracking-tight flex items-center justify-center md:justify-start gap-3">
              Curate New Object <PlusCircle className="text-amber-500 h-6 w-6" />
            </h1>
          </div>

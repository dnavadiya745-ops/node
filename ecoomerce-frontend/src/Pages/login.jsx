...
import { dataContext } from "../content/usercontenxt"; // Check spelling: usercontext or usercontenxt
        ...
        <div className="lg:col-span-5 relative hidden lg:block bg-slate-900 overflow-hidden group">
          ...
          <div className="absolute bottom-12 left-12 right-12 text-white">
            ...
            <p className="text-slate-300 text-sm font-light tracking-wide leading-relaxed">
              Unlock your curated dashboard and continue personalizing your dream spaces with Lumina's premium collection.
            </p>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 p-8 md:p-16 lg:p-20 flex flex-col justify-center bg-white">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.4em] text-amber-600">Secure Access</span>
            </div>
          ...
          <form onSubmit={submitForm} className="space-y-8">
            ...
            <div className="space-y-10">
              ...
              <div className="group relative">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-7 py-3 bg-transparent border-b-2 border-slate-100 focus:border-amber-500 outline-none transition-all text-sm font-medium placeholder-slate-200"
              ...
              <div className="group relative">
                ...
                <div className="relative">
                  <Lock className="absolute left-0 top-3 h-4 w-4 text-slate-300 group-focus-within:text-amber-500 transition-colors" />
                  <input 
                    type="password" 
                    value={password} 
            ...
            <div className="flex items-center justify-between text-[10px] font-black uppercase tracking-widest text-slate-400">
              <label className="flex items-center gap-2 cursor-pointer hover:text-slate-900 transition-colors">
                <input type="checkbox" className="w-4 h-4 rounded border-slate-200 text-amber-600 focus:ring-amber-500" />
                Remember me
              </label>
              <span className="cursor-pointer hover:text-amber-600 transition-colors">Forgot Password?</span>
            </div>

            {/* Submit Button */}
            <button type="submit" className="w-full bg-slate-900 text-white py-5 rounded-2xl font-black uppercase text-[11px] tracking-[0.3em] flex items-center justify-center gap-3 hover:bg-amber-600 shadow-2xl transition-all active:scale-[0.98] group">
              Access Account
          ...
          <div className="mt-12 flex items-center justify-between pt-8 border-t border-slate-50">
            <p className="text-slate-400 text-[13px] font-medium">New to Lumina?</p>

...
module.exports.forgetPassword = async (email) => {
    ...
    // create reset token expiry time = generate link data and time + extra 15 min
    ...
    // resetLink = frontend page link that show newpassword filled with change password btn
